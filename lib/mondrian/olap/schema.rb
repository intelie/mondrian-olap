...
module Mondrian
  module OLAP
    ...
    class Schema < SchemaElement
      ...
      elements :cube, :role, :user_defined_function, :dimension
      ...
      class DimensionUsage < Dimension
        attributes :source
      end
      ...
      class Level < SchemaElement
        ...
        elements :key_expression, :name_expression, :ordinal_expression, :member_formatter, :parent_expression, :property
      end
